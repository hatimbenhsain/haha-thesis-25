    ...
    void Awake()
    {
        ...
        if(randomizeHue){
            if(spriteRenderer.material.HasFloat("_Hue_Offset")){
                spriteRenderer.material.SetFloat("_Hue_Offset",spriteRenderer.material.GetFloat("_Hue_Offset")+Random.Range(-randomizeHueIntensity/2f,randomizeHueIntensity/2f));
            }
