...
=== intro ===
# ambient
Ex: So,\pause I'm leaving. # time: 3
MC: What? # time: 3
...
Ex: No.\pause I just feel the calling. # time: 5
~pause(2)
...
MC: What does this mean for us..? # time: 3
Ex: Evidently this has to be our end. # time: 3
MC: And are you sure I can't -- # time: 2 # speed: fast
...
Ex: Of course I did. This has nothing to do with you. # time: 3
~pause(2)
MC: Will you miss me at all? # time: 3
Ex: I will likely think about you,\pause if I see a rock or a plant or such that has a similar shape to you.\pause Sometimes, it will ache a little bit. # time: 6
Ex: But mostly, I will be too occupied with all the discoveries I am making to really feel "sorrow". # time: 4
MC: What's it like up there? # time: 3
Ex: It's-- # time: 3
~pause(2)
Ex: Do you really want to hear about that? # time: 3
~pause(2)
MC: I guess not. Not really. # time: 3
~pause(2)
MC: What is that, up there?\pause It looks frightening. # time: 4
...
~ pause(2)
MC: Wait.\pause Does it have -- # time: 2
-> END
